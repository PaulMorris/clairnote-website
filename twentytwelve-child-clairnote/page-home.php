...
<h1 id="audiovisualizer-h1" class="entry-title">Clairnote</h1>
...
<p>Clairnote's <a href="http://clairnote.org/clefs/">clef symbols</a>
...
<ul>
<li><a href="javascript:" onClick="avr.videoToggler('videoBlueDanube')">The Blue Danube Waltz, by J.J. Strauss</a> – <a href="http://clairnote.org/sheet-music-files/StraussJJ/O314/blue_danube/blue_danube-dn-let.pdf" target="_blank">Sheet Music (PDF)</a></li>
...
<li><a href="javascript:" onClick="avr.videoToggler('videoGreensleeves')">Greensleeves</a> – <a href="http://clairnote.org/sheet-music-files/Traditional/greensleeves/greensleeves-dn-let.pdf" target="_blank">Sheet Music (PDF)</a></li>
<li><a href="javascript:" onClick="avr.videoToggler('videoBachPrelude')">The Well Tempered Clavier I, Prelude I, by J.S. Bach</a> – <a href="http://clairnote.org/sheet-music-files/BachJS/BWV846/wtk1-prelude1/wtk1-prelude1-dn-let.pdf" target="_blank">Sheet Music (PDF)</a></li>
<li><a href="javascript:" onClick="avr.videoToggler('videoElise')">Für Elise by L.V. Beethoven</a> – <a href="http://clairnote.org/sheet-music-files/BeethovenLv/WoO59/fur_Elise_WoO59/fur_Elise_WoO59-dn-let.pdf" target="_blank">Sheet Music (PDF)</a></li>
<li><a href="javascript:" onClick="avr.videoToggler('videoEntertainer')">The Entertainer by Scott Joplin</a> – <a href="http://clairnote.org/sheet-music-files/JoplinS/entertainer/entertainer-dn-let.pdf" target="_blank">Sheet Music (PDF)</a></li>
</ul>
