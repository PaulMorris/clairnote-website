<?php
/**
 * Template Name: Sheet Music Library Search
 *
...
get_header(); ?>
        ...
        <div id="primary" class="site-content">
            <div id="content" role="main">
                <h1 class="entry-title">Clairnote Sheet Music Library</h1>
...
<h3>About the Clairnote Sheet Music Library</h3>
<p>All of the works in the library were automatically converted from traditional music
    notation into Clairnote using <a href="http://clairnote.org/software/">LilyPond</a>.
    ...
    All of the ".ly" files have been modified slightly to achieve Clairnote output.
    ...
    converting them to Clairnote.)</p>
...
<p><strong>Disclaimer:</strong> These files are works in progress and their
    ...
    any potential layout problems after their conversion to Clairnote.
    (For example, manual tweaks and spacing adjustments for traditional notation
    that are not needed for Clairnote, or that were only needed for earlier
    versions of LilyPond.)  Please <a href="http://clairnote.org/about/">report</a>
